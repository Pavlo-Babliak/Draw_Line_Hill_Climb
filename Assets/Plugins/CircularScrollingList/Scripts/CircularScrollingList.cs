...
namespace AirFishLab.ScrollingList
{
        ...
        IBeginDragHandler, IDragHandler, IEndDragHandler, IScrollHandler
    {
        ...
        /*public void Active()
        {
            for(int i = 0; i < 14; i++) 
            {
                gameObject.transform.GetChild(i).gameObject.GetComponent<Image>().color = new Color32(155, 155, 155, 255);
                gameObject.transform.GetChild(i).gameObject.transform.GetChild(2).gameObject.GetComponent<Image>().color = new Color32(155, 155, 155, 255);
                gameObject.transform.GetChild(i).gameObject.transform.GetChild(3).gameObject.GetComponent<Image>().color = new Color32(155, 155, 155, 255);
                if (i ==13) { gameObject.transform.GetChild(i).gameObject.transform.GetChild(4).gameObject.GetComponent<Image>().color = new Color32(155, 155, 155, 255); }
            }
            transform.GetChild(14).GetComponent<Image>().color = new Color32(255, 255, 255, 255);
            transform.GetChild(14).transform.GetChild(2).gameObject.GetComponent<Image>().color = new Color32(255, 255, 255, 255);
            transform.GetChild(14).transform.GetChild(3).gameObject.GetComponent<Image>().color = new Color32(255, 255, 255, 255);
          //  if (System.Convert.ToInt32(gameObject.name) == 13) { _listBoxes[7].transform.GetChild(System.Convert.ToInt32(gameObject.name)).gameObject.transform.GetChild(3).gameObject.GetComponent<Image>().color = new Color32(255, 255, 255, 255); }
        }*/
